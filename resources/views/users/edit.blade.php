        ...
        <div class="col-md-6">
            <div class="card border border-2 border-secondary rounded-3 shadow-sm bg-white">
                ...
                <div class="card-header bg-white border-bottom border-2 border-secondary py-3">
                    <h1 class="h5 fw-bold text-dark mb-0">Edit Data User</h1>
                    <small class="text-secondary fw-semibold">Perbarui informasi akun atau peran (role) pengguna</small>
                </div>
                ...
                <div class="card-body p-4">
                    <form action="{{ route('admin.users.update', $user) }}" method="POST">
                        ...
                        <div class="mb-4">
                            <label for="password" class="form-label fw-bold text-dark small text-uppercase">
                                Password Baru <span class="text-lowercase fw-normal text-muted"></span>
                            </label>
